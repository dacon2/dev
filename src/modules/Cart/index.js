...
const Cart = () => {
  ...
  if(carts.length === 0) {
    ...
    <div className=' h-[20vh] flex justify-center items-center text-4xl '>Cart is Empty</div>
      <div className='block text-6xl flex justify-center my-4'>
        ⬇️
      </div>
    <div className='flex justify-center my-1'>

   <Link to="/">
   <button class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded display : block">
  Continue Shopping
</button>
